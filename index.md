...
The test pages
tries to include all common page elements,
in HTML and [(Github Flavored) Markdown](https://help.github.com/articles/github-flavored-markdown) formats.

Anything missing? Let us know. Thanks.
...
<!-- fix: use kramdown style - why? why not?? -->
...
<!-- fix: to be done
   add footnotes, etc.  why? why not??
   see/check kramdown what's missing
  -->
